...
```
git clone https://github.gatech.edu/gios-spr-21/pr4.git
```
...
Throughout the project, we encourage you to keep notes on what you have done, how you have approached each part of the project, and what resources you used in preparing your work. We have provided you with a prototype file, `readme-student.md` that you may use throughout the project.

Submit all readmes via Canvas.

Note: Your project report is submitted on canvas in PDF format. There is no limit to the number of times you may submit your readme-student.pdf file.
